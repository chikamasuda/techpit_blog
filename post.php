...
if (!empty($_POST['title']) && !empty($_POST['body'])) {
    ...
    //POSTメソッドで送信されたが、titleかbodyが足りない時
...
<body>
    ...
    <main class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>記事の投稿</h1>
                <form action="post.php" method="post" entype="multipart/form-data">
                    <div class="mb-3">
                        <label class="form-label">タイトル</label>
                        <?php echo !empty($title_alert) ? '<div class="alert alert-danger">' . $title_alert . '</div>' : "" ?>
                        <input type="text" name="title" vallue="<?php echo $title ?>" class="form-control">
                    </div>
                    <div class="mb-3">
